  ...
  <div class="teacherCamera">
    ...
    <div class="teacherCamera-leftTop">
      ...
      <div class="leftTop-box">
        <img v-if="student_teacherMikeStatus" src="@/assets/image/icon-mike-open.png" alt="">
        <img v-if="!student_teacherMikeStatus" src="@/assets/image/icon-mike-close.png" alt="">
      </div>
      <div class="leftTop-box">
        <img v-if="student_teacherCameraStatus" src="@/assets/image/icon-camera-open.png" alt="">
        <img v-if="!student_teacherCameraStatus" src="@/assets/image/icon-camera-close.png" alt="">
      </div>
    </div>
    <!-- 左下角名字 -->
...
export default {
  ...
  computed: {
    ...mapGetters(['student_teacherMikeStatus', 'student_teacherCameraStatus'])
  },
  methods: {
    // 聲音狀態切換
    soundChange() {
