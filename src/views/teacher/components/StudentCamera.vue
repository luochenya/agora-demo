  ...
  <div class="studentCamera">
    ...
    <div class="studentCamera-leftTop">
      ...
      <div class="leftTop-box">
        <img v-if="teacher_studentMikeStatus" src="@/assets/image/icon-mike-open.png" alt="">
        <img v-if="!teacher_studentMikeStatus" src="@/assets/image/icon-mike-close.png" alt="">
      </div>
      <div class="leftTop-box">
        <img v-if="teacher_studentCameraStatus" src="@/assets/image/icon-camera-open.png" alt="">
        <img v-if="!teacher_studentCameraStatus" src="@/assets/image/icon-camera-close.png" alt="">
      </div>
    </div>
    <!-- 左下角名字 -->
    ...
    <div class="studentCamera-rightBottom">
      <transition name="el-fade-in">
        <img v-show="teacher_permissions" src="@/assets/image/icon-shield-open.png" alt="">
      </transition>
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...mapGetters(['teacher_permissions', 'teacher_studentMikeStatus', 'teacher_studentCameraStatus'])
  },
  methods: {
    // 聲音狀態切換
    soundChange() {
      ...
      this.$emit('speakerSoundChange', this.soundStatus)
    },
    // 音量切換
    sliderChange(val) {
      if (val == 0) {
      ...
      this.$emit('speakerSliderChange', val)
    },
  }
}
</script>
