<template>
  <div class="sketchpad" :class="teacher_full_status ? 'sketchpad-full' : ''">
    <!-- 畫板頭部 -->
    <transition name="el-fade-in">
      <div
        class="sketchpad-head"
        v-show="!teacher_full_status || (teacher_full_status && fullRightTopShow)"
        @mouseover="fullRightTopMouseover" @mouseleave="fullRightTopMouseleave"
      >
        <div class="sketchpad-head-left" v-show="!teacher_full_status">
        ...
        <div class="sketchpad-head-right">
          <div @click="shieldChange()">
            <img v-if="teacher_permissions" src="@/assets/image/icon-shield-open.png" alt="">
            <img v-if="!teacher_permissions" src="@/assets/image/icon-shield-clost.png" alt="">
          </div>
          <div @click="addClick()">
    ...
    <div class="sketchpad-box">
      <transition name="el-zoom-in-center">
        <div
          ...
          v-show="!teacher_full_status || (teacher_full_status && fullLeftShow)"
          @mouseover="fullLeftMouseover" @mouseleave="fullLeftMouseleave"
        >
          <!-- 游標 -->
          <div
            class="left-box"
            :class="toolCursorStatus ? 'tool-btns' : 'tool-btn'"
            @click="toolStatusChange('toolCursorStatus')"
          >
            <img v-if="!toolCursorStatus" src="@/assets/image/icon-tool1-close.png" alt="">
            <img v-if="toolCursorStatus" src="@/assets/image/icon-tool1-open.png" alt="">
          </div>
          <!-- 文字 -->
          <div
            class="left-box"
          ...
          <div
            class="left-box"
            :class="toolFontWeightStatus ? 'tool-btns' : 'tool-btn'"
            @click="toolStatusChange('toolFontWeightStatus')"
          >
            <img v-if="!toolFontWeightStatus" src="@/assets/image/icon-tool6-close.png" alt="">
            <img v-if="toolFontWeightStatus" src="@/assets/image/icon-tool6-open.png" alt="">
          </div>
          <!-- 形狀 -->
          <div class="left-box">
            <el-popover placement="right" trigger="hover" popper-class="sketchpad-popover">
          ...
          <div
            class="left-box"
            :class="toolzoomStatus ? 'tool-btns' : 'tool-btn'"
            @click="toolStatusChange('toolzoomStatus')"
          >
            <img v-if="!toolzoomStatus" src="@/assets/image/icon-tool11-close.png" alt="">
            <img v-if="toolzoomStatus" src="@/assets/image/icon-tool11-open.png" alt="">
          </div>
          <!-- 縮小 -->
          <div
            class="left-box"
            :class="toolshrinkStatus ? 'tool-btns' : 'tool-btn'"
            @click="toolStatusChange('toolshrinkStatus')"
          >
            <img v-if="!toolshrinkStatus" src="@/assets/image/icon-tool12-close.png" alt="">
            <img v-if="toolshrinkStatus" src="@/assets/image/icon-tool12-open.png" alt="">
          </div>
          <!-- 調色板 -->
          <div
            class="left-box"
      ...
      <div class="sketchpad-box-right">
        ...
        <div class="sketchpad-box-right-foo" v-if="!teacher_full_status">
          <div class="foo-left">
            <div class="foo-left-box" @click="pageChange('frontPage')">
              <img v-if="!frontPageStatus" src="@/assets/image/icon-retreat-open.png" alt="">
              <img v-if="frontPageStatus" src="@/assets/image/icon-retreat-dis.png" alt="">
            </div>
            <div class="foo-left-box" @click="pageChange('previousPage')">
              <img v-if="!previousPageStatus" src="@/assets/image/icon-upon-open.png" alt="">
              <img v-if="previousPageStatus" src="@/assets/image/icon-upon-dis.png" alt="">
            </div>
            <div class="foo-left-div">
              {{ mediaProgressNum }} / {{ mediaLengthNum }}
            </div>
            <div class="foo-left-box" @click="pageChange('nextPage')">
              <img v-if="!nextPageStatus" src="@/assets/image/icon-down-open.png" alt="">
              <img v-if="nextPageStatus" src="@/assets/image/icon-down-dis.png" alt="">
            </div>
            <div class="foo-left-box" @click="pageChange('lastPage')">
              <img v-if="!lastPageStatus" src="@/assets/image/icon-onward-open.png" alt="">
              <img v-if="lastPageStatus" src="@/assets/image/icon-onward-dis.png" alt="">
            </div>
            <div class="foo-left-music">
              <img src="@/assets/image/icon-music-open.png" alt="">
            </div>
            <div class="foo-left-select">
              <el-select v-model="fileSelectCheck" value-key="id" @change="fileSelectChange" placeholder="Select audios or videos.">
                <el-option-group
                  v-for="group in fileSelectList"
                  :key="group.label"
                  :label="group.label">
                  <el-option
              ...
              <div class="foo-left-select-div">
                <img src="@/assets/image/icon-select.png" alt="">
              </div>
            </div>
          </div>
          <div class="foo-right">
            <div class="foo-media" v-if="mediaShow">
              <div class="foo-media-btn" @click="playChange('play')">
                <img v-if="!mediaPlayStatus" src="@/assets/image/icon-play-open.png" alt="">
                <img v-if="mediaPlayStatus" src="@/assets/image/icon-pause-open.png" alt="">
              </div>
              <div class="foo-media-btn" @click="playChange('stop')">
                <img v-if="!mediaStopStatus" src="@/assets/image/icon-stop-open.png" alt="">
                <img v-if="mediaStopStatus" src="@/assets/image/icon-stop-dis.png" alt="">
              </div>
              <div class="foo-media-time">
                {{ mediaCurrentDuration }}
              </div>
              <div class="foo-media-slider">
                <el-slider v-model="mediaSlider" :show-tooltip="false" @change="mediaChange"></el-slider>
              </div>
              <div class="foo-media-time">
                {{ mediaTotalDuration }}
              </div>
            ...
            <div class="foo-volume" v-if="volumeShow">
              ...
              <!-- 小屏幕豎向展示 -->
              <div class="volume-btn volume-btn-show" @click="volumeClick">
                <el-popover
                  placement="top"
                  trigger="hover"
                  popper-class="sketchpad-popovers"
                >
                  <el-slider height="80px" vertical v-model="volumeSlider" @change="volumeChange"></el-slider>
                  <img v-if="!volumeStatus" slot="reference" src="@/assets/image/icon-volume-open.png" alt="">
                  <img v-if="volumeStatus" slot="reference" src="@/assets/image/icon-volume-close.png" alt="">
                </el-popover>
              </div>
            </div>
    ...
    <transition name="el-zoom-in-bottom">
      <div
        ...
        v-show="teacher_full_status && fullBottomShow"
        @mouseover="fullBottomMouseover" @mouseleave="fullBottomMouseleave"
      >
        <div class="bottom-slider">
          <el-slider v-model="mediaSlider" v-if="mediaShow" :show-tooltip="false" @change="mediaChange"></el-slider>
        </div>
        <div class="bottom-box">
          <div class="bottom-box-left">
            <div class="bottom-media-btn" v-if="mediaShow" @click="playChange('play')">
              <img v-if="!mediaPlayStatus" src="@/assets/image/icon-play-open.png" alt="">
              <img v-if="mediaPlayStatus" src="@/assets/image/icon-pause-open.png" alt="">
            </div>
            <div class="bottom-media-btn" v-if="mediaShow" @click="playChange('stop')">
              <img v-if="!mediaStopStatus" src="@/assets/image/icon-stop-open.png" alt="">
              <img v-if="mediaStopStatus" src="@/assets/image/icon-stop-dis.png" alt="">
            </div>
            ...
            <div class="bottom-media-btn" @click="pageChange('previousPage')">
              <img v-if="!previousPageStatus" class="img1" src="@/assets/image/icon-upon-open.png" alt="">
              <img v-if="previousPageStatus" class="img1" src="@/assets/image/icon-upon-dis.png" alt="">
            </div>
            <div class="bottom-media-div">
              {{ mediaProgressNum }} / {{ mediaLengthNum }}
            </div>
            <div class="bottom-media-btn" @click="pageChange('nextPage')">
              <img v-if="!nextPageStatus" class="img1" src="@/assets/image/icon-down-open.png" alt="">
              <img v-if="nextPageStatus" class="img1" src="@/assets/image/icon-down-dis.png" alt="">
            </div>
            <div class="bottom-media-music">
              <img src="@/assets/image/icon-music-open.png" alt="">
            </div>
            <div class="bottom-media-select">
              <el-select v-model="fileSelectCheck" value-key="id" @change="fileSelectChange" placeholder="Select audios or videos." :popper-append-to-body="false">
                <el-option-group
                  v-for="group in fileSelectList"
                  :key="group.label"
                  :label="group.label">
              ...
              <div class="bottom-media-select-div">
                <img src="@/assets/image/icon-select.png" alt="">
              </div>
            </div>
          </div>
          <div class="bottom-box-right">
            ...
            <div class="bottom-media-btn" @click="fullChange">
    ...
    <div class="sketchpad-full-rightTop" @mouseover="fullRightTopMouseover" @mouseleave="fullRightTopMouseleave"></div>
...
export default {
  ...
  data() {
    return {
      ...
      toolRandomCheck: 1,
      // 工具欄選中狀態-字體粗細
      toolFontWeightStatus: false,
      // 工具欄選中狀態-形狀
      toolshapeStatus: false,
      toolshapeCheck: 1,
      // 工具欄選中狀態-放大
      toolzoomStatus: false,
      // 工具欄選中狀態-縮小
      toolshrinkStatus: false,
      // 工具欄選中狀態-調色板
      ...
      mediaShow: false,
      // 媒體播放-暫停
      mediaPlayStatus: false,
      // 媒體播放-停止
      mediaStopStatus: false,
      // 媒體播放-當前時長
      ...
      // 全屏模式-右上權限顯示
      fullRightTopShow: false,
    }
  },
  computed: {
    ...mapGetters(['teacher_full_status', 'teacher_permissions'])
  },
  methods: {
    // 盾牌切換
    shieldChange() {
      this.$store.commit('teacher/SET_PERMISSIONS', !this.teacher_permissions)
    },
    // 新增空白頁
    addClick() {
    ...
    // 媒體分頁切換
    pageChange(type) {
      if (type === 'frontPage') { // 最前頁
        this.frontPageStatus = !this.frontPageStatus
      } else if (type === 'previousPage') { // 上一頁
        this.previousPageStatus = !this.previousPageStatus
      } else if (type === 'nextPage') { // 下一頁
        this.nextPageStatus = !this.nextPageStatus
      } else if (type === 'lastPage') { // 最後頁
        this.lastPageStatus = !this.lastPageStatus
      }
    },
    // 媒體播放狀態切換
    playChange(type) {
      if (type === 'play') {
        this.mediaPlayStatus = !this.mediaPlayStatus
      } else {
        this.mediaStopStatus = !this.mediaStopStatus
      }
    },
    // 媒體文件切換選擇
    fileSelectChange() {
      // 如果音頻有選中的話 那就顯示進度條和音量
      if (this.fileSelectCheck) {
        this.mediaShow = true
    ...
    // 全屏切換
    fullChange() {
      this.$store.commit('teacher/SET_FULL_STATUS', !this.teacher_full_status)
    },
    // 全屏模式-左側工具欄劃上顯示
    fullLeftMouseover() {
    ...
    // 全屏模式-右上權限劃上顯示
    fullRightTopMouseover() {
      this.fullRightTopShow = true
    },
    // 全屏模式-右上權限劃開隱藏
    fullRightTopMouseleave() {
      this.fullRightTopShow = false
    },
