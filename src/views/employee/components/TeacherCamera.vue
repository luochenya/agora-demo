  ...
  <div class="teacherCamera">
    ...
    <div class="teacherCamera-leftTop">
      ...
      <div class="leftTop-box">
        <img v-if="employee_teacherMikeStatus" src="@/assets/image/icon-mike-open.png" alt="">
        <img v-if="!employee_teacherMikeStatus" src="@/assets/image/icon-mike-close.png" alt="">
      </div>
      <div class="leftTop-box">
        <img v-if="employee_teacherCameraStatus" src="@/assets/image/icon-camera-open.png" alt="">
        <img v-if="!employee_teacherCameraStatus" src="@/assets/image/icon-camera-close.png" alt="">
      </div>
    </div>
    <!-- 左下角名字 -->
...
export default {
  ...
  computed: {
    ...mapGetters(['employee_teacherMikeStatus', 'employee_teacherCameraStatus'])
  },
  methods: {
    // 聲音狀態切換
    soundChange() {
