<template>
  <div class="sketchpad" :class="employee_full_status ? 'sketchpad-full' : ''">
    <!-- 畫板頭部 -->
    <transition name="el-fade-in">
      <div class="sketchpad-head">
        <div class="sketchpad-head-left" v-show="!employee_full_status">
    ...
    <div class="sketchpad-box">
      <div class="sketchpad-box-left"></div>
      <div class="sketchpad-box-right">
        <div class="sketchpad-box-right-head"></div>
        <div class="sketchpad-box-right-foo" v-if="!employee_full_status">
          <div class="foo-left">
    ...
    <transition name="el-zoom-in-bottom">
      <div
        ...
        v-show="employee_full_status && fullBottomShow"
      ...
      >
        ...
        <div class="bottom-box">
          ...
          <div class="bottom-box-right">
            ...
            <div class="bottom-media-btn" @click="fullChange" v-if="employee_full_status">
...
export default {
  ...
  methods: {
    ...
    // 全屏切換
    fullChange() {
      this.$store.commit('employee/SET_FULL_STATUS', !this.employee_full_status)
    },
    // 全屏模式-底部播放欄劃上顯示
    fullBottomMouseover() {
